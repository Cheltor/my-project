...
export default function PendingInspections() {
  ...
  const totalPages = Math.max(1, Math.ceil(inspections.length / inspectionsPerPage));
  ...
  return (
    <div className="mt-5 px-4 sm:px-6 lg:px-8">
      ...
      {inspections.length === 0 ? (
        <div className="mt-8 text-center text-gray-500">There are no pending inspections.</div>
      ) : (
        <>
          ...
          {inspections.length > inspectionsPerPage && (
