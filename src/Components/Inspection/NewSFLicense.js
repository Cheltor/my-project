...
export default function NewSFLicense({
  ...
  onClose,
  renderAsModal = false,
  title = "Create New Single Family License",
  description,
}) {
  ...
  const headingId = "new-sf-license-heading";
  const descriptionId = description ? "new-sf-license-description" : undefined;
          ...
          {currentStep === "attachments" && (
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Upload documents or skip to continue.
              </p>
            </div>
          )}
