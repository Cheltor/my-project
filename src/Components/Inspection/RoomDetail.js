...
export default function RoomDetail() {
  ...
  useEffect(() => {
    ...
    fetch(`https://civicode-2eae16143963.herokuapp.com/rooms/${id}`)
      .then((response) => {
        if (!response.ok) {
    ...
    fetch(`https://civicode-2eae16143963.herokuapp.com/rooms/${id}/prompts`)
  ...
  const handleDeletePrompt = (promptId) => {
    fetch(`https://civicode-2eae16143963.herokuapp.com/prompts/${promptId}`, {
      method: 'DELETE',
    })
      .then(() => {
